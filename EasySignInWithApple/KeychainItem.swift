...
struct KeychainItem {
    ...
    static var currentUserId: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.bellkung.EasySignInWithApplez", account: "userId").readItem()
    ...
    static func deleteUserIdFromKeychain() {
        do {
            try KeychainItem(service: "com.bellkung.EasySignInWithApplez", account: "userId").deleteItem()
        } catch {
